                        ...
                        for line in temp_reader:
                                if(counter == 0):
                                        ...
                                        if(len(line) == comparelen):                                                
                                                ...
                                                print(" - ? - Elemento necessita di maggiori analisi")
                                                print("")
                                                print("----INFORMAZIONI----:")
                                                print("")
                                                print("")
                                                print("Link Sorgente: " + str(line[0]))
                                                print("Titolo Pagina Sorgente: " + str(line[1]))
                                                print("Target URL: " + str(line[2]))
                                                print("Anchor Text: " + str(line[6]))
                                                print("Prima Apparizione: " + str(line[7]))
                                                print("Ultima Apparizione: " + str(line[8]))
                                                print("Domain Auth: " + str(line[3]))
                                                print("Page Auth: " + str(line[4]))
                                                print("")
                                                print("---------------------------------")
                                                print("")
                                                ...
                                                if(x == "StopAll"):
                                                        ...
                                                        print(line[0])
                                                        line.append("Necessita ulteriori analisi")
                                                        temp_writer.writerow(line)                                                        
                                                else:
                                                        print(line[0])
                                                        line.append(str(x))
